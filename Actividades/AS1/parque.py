class Parque:
    ...
    def distribuir_personas(self):
        ...
        for persona in self.personas:
            nombre_atraccion = persona.siguiente_juego()
            puede_ingresar = persona.revision_juegos()

            if puede_ingresar:
                siguiente_atraccion = self.atracciones[nombre_atraccion]
                siguiente_atraccion.ingresar_persona(persona)
